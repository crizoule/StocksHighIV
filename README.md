...
- **Long history:** scored back to August 2009. Over the overlap with CNN's published feed (1,254 sessions from September 2021), correlation 0.97, average gap 3.9 points, same rating on 75% of sessions. 2020 to 2022 scores on six components, because Cboe's archive files stop in October 2019 and the app's own stored put/call history starts in 2023.
