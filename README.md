...
The dashboard has four tabs: **IV scan** (the screen itself), **Sentiment**, **Leverage** and **Searches**. The dashboard remembers the open tab. Each context tab carries one label, shown on the tab and at the top of its page: **Bullish**, **Leaning bullish**, **Neutral**, **Mixed**, **Leaning bearish**, **Bearish** or **Insufficient data**, plus **historic high** or **historic low** when an input sits within 2 percentile points of either end of its own history.
...
| Leverage | FINRA margin debt change 25% · hedge funds 15% (balance sheet) + 10% (with derivatives) · Fed Z.1 margin loans ÷ stocks 15% · 3× ETF volume 15% · 3× ETF bull share 10% · leveraged funds in S&P futures 10% | Each measure's percentile in its own history: the higher, the more bearish (more borrowed money to unwind). Leveraged funds count as bearish at either extreme of their 3-year range. Readings older than their cadence allows (75 days for monthly, 200 for quarterly) are left out. |
